...
public class GameTest {
    ...
    public void shouldRegisterPlayer() {
        Game game = new Game();
        Player player = new Player(4, "Aisenkora", 15);
    ...
    public void shouldRoundWithRegisteredPlayers() throws NotRegisteredException {
        Game game = new Game();
        Player player1 = new Player(4, "Aisenkora", 100);
        Player player2 = new Player(5, "Aesonne", 75);
    ...
    public void shouldRoundIfSecondPlayerStronger() throws NotRegisteredException {
        Game game = new Game();
        Player player1 = new Player(4, "Aisenkora", 75);
        Player player2 = new Player(5, "Aesonne", 100);
        game.register(player1);
        game.register(player2);
    ...
    public void shouldRoundWithUnRegisteredPlayers() {
        Game game = new Game();
        Player player1 = new Player(4, "Aisenkora", 99);
        Player player2 = new Player(5, "Aesonne", 75);
    ...
    public void shouldRoundWithUnRegisteredPlayer1() {
        Game game = new Game();
        Player player1 = new Player(5, "Aesonne", 100);
        Player player2 = new Player(4, "Aisenkora", 99);
        game.register(player2);
        Exception exception = assertThrows(NotRegisteredException.class, () -> {
            game.round("Неизвестный игрок", "Aisenkora");
        });
    ...
    public void shouldRoundWithUnRegisteredPlayer2() {
        ...
        game.register(player1);
        Exception exception = assertThrows(NotRegisteredException.class, () -> {
            game.round("Aesonne", "Неизвестный игрок");
        });
